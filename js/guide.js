...
const Guide = {
  ...
  TOPICS: [
    ...
    { k: ['신급', '아르세우스', '디아루가', '펄기아', '기라티나', '마스터볼', '신의 오브'], a: () =>
      '⚡ 신급 포켓몬(디아루가·펄기아·기라티나·아르세우스): 신의 오브(메가스톤+다이아4+하이퍼볼+사탕2 조합)를 가방에서 사용해 소환!\n' +
      'Lv.85+ 보스급이라 매우 강하고, 포획률이 극악이라 마스터볼(하이퍼볼3+메가스톤+사탕2+에메랄드3) 없이는 거의 못 잡아요. 마스터볼 = 100% 포획!' },
    { k: ['기술 명령', '필드 기술', '화염방사', '불 뿜'], a: () =>
      '⚡ X키: 파트너에게 기술 명령! 파트너를 내보낸 상태에서 X를 누르면 내 시선 방향으로 가장 강한 기술을 발사해요.\n' +
      '야생 포켓몬과 몬스터에게 피해를 주고, 쓰러뜨리면 기절 포획도 가능! (쿨타임 2.5초)' },
    { k: ['샤이니', 'shiny', '색이 다른'], a: () =>
  ...
  _systemPrompt(){
    return '너는 복셀 게임 "포케크래프트"(마인크래프트+포켓몬 웹게임)의 인게임 도우미야. 한국어로 짧고 친절하게(5줄 이내) 답해.\n' +
      ...
      '메가진화(메가스톤), 특성(타입별), 동행 효과, 샤이니, 화석 복원, 알 부화, ' +
